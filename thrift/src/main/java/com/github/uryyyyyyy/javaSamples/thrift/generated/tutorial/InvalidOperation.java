...
public class InvalidOperation extends TException implements org.apache.thrift.TBase<InvalidOperation, InvalidOperation._Fields>, java.io.Serializable, Cloneable {
  ...
  public int compareTo(InvalidOperation other) {
    ...
    lastComparison = Boolean.valueOf(isSetWhatOp()).compareTo(typedOther.isSetWhatOp());
    if (lastComparison != 0) {
      return lastComparison;
    }
    if (isSetWhatOp()) {
      lastComparison = org.apache.thrift.TBaseHelper.compareTo(this.whatOp, typedOther.whatOp);
      if (lastComparison != 0) {
        return lastComparison;
      }
    }
