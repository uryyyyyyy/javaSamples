 ...
 *  @generated
 */
package com.github.uryyyyyyy.javaSamples.thrift.generated.tutorial;

import com.github.uryyyyyyy.javaSamples.thrift.generated.shared.SharedService;
...
public class Calculator {
  ...
  public interface AsyncIface extends SharedService .AsyncIface {
    ...
    public void ping(org.apache.thrift.async.AsyncMethodCallback<AsyncClient.ping_call> resultHandler) throws TException;

    public void add(int num1, int num2, org.apache.thrift.async.AsyncMethodCallback<AsyncClient.add_call> resultHandler) throws TException;

    public void calculate(int logid, Work w, org.apache.thrift.async.AsyncMethodCallback<AsyncClient.calculate_call> resultHandler) throws TException;

    public void zip(org.apache.thrift.async.AsyncMethodCallback<AsyncClient.zip_call> resultHandler) throws TException;
  ...
  public static class AsyncClient extends SharedService.AsyncClient implements AsyncIface {
    ...
    public void ping(org.apache.thrift.async.AsyncMethodCallback<ping_call> resultHandler) throws TException {
      checkReady();
    ...
    public static class ping_call extends org.apache.thrift.async.TAsyncMethodCall {
      public ping_call(org.apache.thrift.async.AsyncMethodCallback<ping_call> resultHandler, org.apache.thrift.async.TAsyncClient client, org.apache.thrift.protocol.TProtocolFactory protocolFactory, org.apache.thrift.transport.TNonblockingTransport transport) throws TException {
    ...
    public void add(int num1, int num2, org.apache.thrift.async.AsyncMethodCallback<add_call> resultHandler) throws TException {
      checkReady();
    ...
    public static class add_call extends org.apache.thrift.async.TAsyncMethodCall {
      private int num1;
      private int num2;
      public add_call(int num1, int num2, org.apache.thrift.async.AsyncMethodCallback<add_call> resultHandler, org.apache.thrift.async.TAsyncClient client, org.apache.thrift.protocol.TProtocolFactory protocolFactory, org.apache.thrift.transport.TNonblockingTransport transport) throws TException {
        super(client, protocolFactory, transport, resultHandler, false);
        this.num1 = num1;
        this.num2 = num2;
      }
    ...
    public void calculate(int logid, Work w, org.apache.thrift.async.AsyncMethodCallback<calculate_call> resultHandler) throws TException {
      checkReady();
    ...
    public static class calculate_call extends org.apache.thrift.async.TAsyncMethodCall {
      private int logid;
      private Work w;
      public calculate_call(int logid, Work w, org.apache.thrift.async.AsyncMethodCallback<calculate_call> resultHandler, org.apache.thrift.async.TAsyncClient client, org.apache.thrift.protocol.TProtocolFactory protocolFactory, org.apache.thrift.transport.TNonblockingTransport transport) throws TException {
        super(client, protocolFactory, transport, resultHandler, false);
        this.logid = logid;
        this.w = w;
      }
    ...
    public void zip(org.apache.thrift.async.AsyncMethodCallback<zip_call> resultHandler) throws TException {
      checkReady();
    ...
    public static class zip_call extends org.apache.thrift.async.TAsyncMethodCall {
      public zip_call(org.apache.thrift.async.AsyncMethodCallback<zip_call> resultHandler, org.apache.thrift.async.TAsyncClient client, org.apache.thrift.protocol.TProtocolFactory protocolFactory, org.apache.thrift.transport.TNonblockingTransport transport) throws TException {
